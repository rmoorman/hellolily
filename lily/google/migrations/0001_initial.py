...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'google_flowmodel', (
            ('id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.CustomUser'], primary_key=True)),
            ('flow', self.gf('oauth2client.django_orm.FlowField')(null=True)),
        ))
        db.send_create_signal(u'google', ['FlowModel'])

        # Adding model 'CredentialsModel'
        db.create_table(u'google_credentialsmodel', (
            ('id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.CustomUser'], primary_key=True)),
            ('credential', self.gf('oauth2client.django_orm.CredentialsField')(null=True)),
        ))
        db.send_create_signal(u'google', ['CredentialsModel'])


    def backwards(self, orm):
        # Deleting model 'FlowModel'
        db.delete_table(u'google_flowmodel')

        # Deleting model 'CredentialsModel'
        db.delete_table(u'google_credentialsmodel')
    ...
    models = {
        ...
        u'google.credentialsmodel': {
            'Meta': {'object_name': 'CredentialsModel'},
            'credential': ('oauth2client.django_orm.CredentialsField', [], {'null': 'True'}),
            'id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.CustomUser']", 'primary_key': 'True'})
        },
        u'google.flowmodel': {
